...
export class PageEditor extends React.Component {
    constructor (props) {
        super(props);
        this.state = { pageId: this.props.id, editorText: '', loading: true };
    ...
    componentDidMount () {
        $.ajax({
            method: 'GET',
            url: '/admin/api/page/' + this.props.id,
            dataType: 'json',
            mimeType: 'application/json',
            success: (response) => {
                console.log(response.page);
                this.setState({ loading: false, editorText: response.page.content });
            }
        });
    }
    ...
    save () {
        ...
        $.ajax({
            ...
            dataType: 'json',
            mimeType: 'application/json',
            data: { _id: this.state.pageId, content: this.state.editorText },
            success: (response) => {
